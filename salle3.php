...
<h3>Vélo de elliptyque : Candeloro </h3>
                        ...
                        <div class="carousel-inner item">                                 
                            <div class="item active">                                     
                                <div class="col-md-3 col-sm-4 col-xs-12">
                                    <a href="#"><img src="img/SalleCandeloro1.jpg" class="img-responsive"></a>
                                </div>                                 
                            </div>                                 
                            <div class="item">                                     
                                <div class="col-md-3 col-sm-4 col-xs-12">
                                    <a href="#"><img src="img/SalleCandeloro2.jpg" class="img-responsive"></a>
                                </div>                                
                            </div>                                                             
                        </div>                            
                    </div>                         
